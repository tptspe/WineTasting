...
class RatingSymbol extends React.PureComponent {
	render() {
		...
		return (
			<span
				style={style}
				className={this.props.lastNode ? 'selected' : ''}
...
RatingSymbol.propTypes = {
	...
	inactiveIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.object, PropTypes.element])
		.isRequired,
	activeIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.object, PropTypes.element])
		.isRequired,
